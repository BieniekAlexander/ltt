...
if __name__ == "__main__":
    ...
    parser.add_argument('--mongodb-uri', dest='mongodb_uri', default=os.environ['MONGODB_URI'], required=False,
                        help='URI used to connect to MongoDB')
    parser.add_argument('--language', dest='language', required=False,
                        default="polish", help='language schemata and indices being updated')
    # TODO language arg
